...
def moss():
    chart_data, _ = ft.use_state(
        ChartData(
            sections=[
                SectionData(value=40, radius=normal_radius,
                            color=ft.Colors.BLUE),
                SectionData(value=30, radius=normal_radius,
                            color=ft.Colors.YELLOW),
                SectionData(value=15, radius=normal_radius,
    ...
    chart = fch.PieChart(
        sections=[PieChartSection(section=section)
