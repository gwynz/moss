            ...
            controls=[
                ...
                ft.Row(
                    ...
                    controls=[
                        ...
                        ft.Button("Play Or Pause",
                                  on_click=handle_play_or_pause),
                        ...
                        ft.Button("Add Random Media",
                                  on_click=handle_add_media),
                        ft.Button("Remove Random Media",
                                  on_click=handle_remove_media),
                        ft.Button("Enter Fullscreen",
                                  on_click=handle_fullscreen),
                    ],
                ),
                ft.Slider(
                    min=0,
