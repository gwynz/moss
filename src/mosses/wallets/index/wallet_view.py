...
def WalletManager():
    ...
    confirm_delete, set_confirm_delete = ft.use_state(None)  # Wallet dict or None
        ...
        children.append(
            ft.Banner(
                ...
                actions=[
                    ft.TextButton(
                        "Dismiss",
                        on_click=lambda _: (setattr(model, "error_message", "")),
                    )
                ],
                open=True,
            )
                ...
                controls=[
                    ...
                    ft.Row(
                        ...
                        controls=[
                            ...
                            ft.Text(f"Page {model.page} of {model.total_pages}"),
                            ft.IconButton(
