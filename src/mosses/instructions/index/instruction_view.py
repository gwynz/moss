        ...
        content=ft.Column(
            [
                ...
                ft.DataTable(
                    ...
                    column_spacing=20,
                    columns=[
                        ft.DataColumn(ft.Text("Tool", weight=ft.FontWeight.BOLD)),
                        ft.DataColumn(
                            ft.Text("Core Engine", weight=ft.FontWeight.BOLD)
                        ),
                        ft.DataColumn(ft.Text("Core Tool", weight=ft.FontWeight.BOLD)),
                        ft.DataColumn(ft.Text("Extensions", weight=ft.FontWeight.BOLD)),
                        ft.DataColumn(ft.Text("Proxy", weight=ft.FontWeight.BOLD)),
                        ft.DataColumn(
                            ft.Text("Download Engine", weight=ft.FontWeight.BOLD)
                        ),
                    ],
                    rows=[
                        ft.DataRow(
